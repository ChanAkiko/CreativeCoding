...
void setup() {
  ...
  cp5.addTextfield("inputText")
    .setPosition((int)(width * 0.01), (int)(height * 0.02))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
  ...
  cp5.addSlider("fontSize")
    .setPosition((int)(width * 0.01), (int)(height * 0.06))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
    .setFont(createFont("Arial", 20))
    .setRange(30, 150)
    .setValue(80)
  ...
  cp5.addSlider("maxJAngle")
    .setPosition((int)(width * 0.01), (int)(height * 0.12))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
    .setFont(createFont("Arial", 20))
    .setRange(0, 1440)
    .setValue(180)
  ...
  cp5.addColorPicker("textColor")
    .setPosition((int)(width * 0.01), (int)(height * 0.15))
    .setSize((int)(width * 0.1), (int)(height * 0.1))
    .setFont(createFont("Arial", 20))
  ...
  cp5.addButton("saveCurrentFrame")
    ...
    .setPosition((int)(width * 0.01), (int)(height * 0.2))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
    .setFont(createFont("Arial", 20));

  cp5.addButton("startRecording")
    .setLabel("Start Recording")
    .setPosition((int)(width * 0.01), (int)(height * 0.23))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
    .setFont(createFont("Arial", 20));

  cp5.addButton("stopRecording")
    .setLabel("Stop Recording")
    .setPosition((int)(width * 0.01), (int)(height * 0.26))
    .setSize((int)(width * 0.1), (int)(height * 0.02))
    .setFont(createFont("Arial", 20));
